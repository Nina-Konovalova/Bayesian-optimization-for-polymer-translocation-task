...
#                             ]
# #
# CONSTRAINTS = [             {'name': 'constr_1', 'constraint': 'abs(x[:,15])-4*np.sqrt(2*np.pi*np.exp(1))*x[:,0]'},
...
CONSTRAINTS = [             {'name': 'constr_1', 'constraint': 'abs(x[:,10])-4*np.sqrt(2*np.pi*np.exp(1))*x[:,0]'},
